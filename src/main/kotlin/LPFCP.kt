...
object LPFCP {
     ...
     */
    class IncorrectFunctionNameException(msg: String) : Exception(msg)
    
    /**
     * Exception thrown when the `functionArgs` key is missing or invalid in the request.
     * @param msg The error message describing the issue.
     */
    class IncorrectFunctionArgsException(msg: String) : Exception(msg)

    /**
     * Exception thrown when no function with the specified name and parameters is found.
     * @param msg The error message describing the issue.
     */
    class NoMatchingFunctionFound(msg: String) : Exception(msg)
     ...
     */
    class ExecutedFunctionThrowException(e: Throwable) : Exception(e)
